...
cfg.MODEL.WEIGHTS = os.path.join("./output_icra_segment/mutliple_train_3/finetune_bf4ee699-0f29-4a39-a7d6-025fafbc4c66", "model_final.pth")  # trained model
...
image_path = "./valid_14.jpg"  # Replace with actual image
